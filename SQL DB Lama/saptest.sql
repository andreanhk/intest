...
(1, 1000, 'Samator', NULL, 'SAPFICO', 'SAPMM', 'SAPPM', 'SAPPP', 'SAPSD', 'Admin', '2018-05-20 17:29:33', NULL),
(2, 2000, 'Aneka Gas Industri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 3000, 'Samator Gas Industri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 3016, 'SGI Rantau Prapat', '2018-04-01', 'Putra', 'Purwandi', 'Zamroni', 'Abta', 'Alex', 'Admin', '2018-05-26 00:06:59', NULL),
(5, 3916, 'SGI Depo Sibolga', '2018-04-01', 'Yohanes', 'Nino', 'Zamroni', 'Rita', 'Suyanto', 'Admin', '2018-05-26 00:07:39', NULL),
(6, 2072, 'AGI Manado', '2018-04-01', 'Aris', 'Thomas', 'Achmad', 'Fitri', 'Rendra', 'Admin', '2018-06-03 15:07:54', 'MM'),
(7, 2073, 'AGI Ternate', '2018-04-01', 'Aris', 'Thomas', 'Achmad', 'Fitri', 'Rendra', 'Admin', '2018-06-03 15:09:11', 'MM'),
(8, 2065, 'AGI Luwuk', '2018-06-01', 'Aris', 'Thomas', 'Zamroni', 'Fitri', 'Suyanto', 'Admin', '2018-06-03 14:58:56', 'SD');
...
(170, 'MRP, Prd.Order', 'Define MRP Creation Indicator', 'SPRO', '', 'Create', 'PP', 'Admin', '2018-05-28 21:33:30'),
...
(180, 'MRP, Prd.Order', 'Define parameter for determining basic dates', 'SPRO', '', 'Check', 'PP', 'Admin', '2018-05-28 21:33:40'),
...
(1, 'ABAP', 'ABAP', 'Admin', '2018-06-03 00:46:07'),
(2, 'BASIS', 'Basis', 'Admin', '2018-06-03 00:46:12'),
...
(2, 'Andrean', '0969f3b18795cb6cba11a76a807b5702', 'Andrean HK', 'BASIS', 'Admin', '2018-05-16 22:51:18'),
(10, 'Sony', 'd239371fa97f976721de3f6d04dac38d', 'Sony', 'ABAP', NULL, NULL),
(11, 'Ferry', '1944557e5d7c92c80e71c752687ccd53', 'Ferry', 'ABAP', NULL, NULL),
(12, 'Faris', 'e36b7dbb6a0d2785a2bc9e08abb28857', 'Faris', 'ABAP', NULL, NULL),
(13, 'Johan', '4a2f14c39084e6aa681d940d62852a67', 'Johan', 'ABAP', NULL, NULL),
(14, 'Tjandra', 'f7f0e971ba52e4c7998fe8c332c4400c', 'Tjandra', 'BASIS', NULL, NULL),
(16, 'Nurnia', '032961f455a35d43cb30e38be21c8886', 'Nurnia', 'FICO', NULL, NULL),
(17, 'Yohanes', '3e6bac435ca83d5bf08b2ea9d1605c40', 'Yohanes', 'FICO', NULL, NULL),
(18, 'Putra', '89c124640bac613a07396ae9445069c4', 'Putra', 'FICO', NULL, NULL),
(19, 'Aris', '0710b4a5e9dfaf1f01d538d41cb66744', 'Aris', 'FICO', 'Aris', '2018-06-02 02:53:45'),
(20, 'Purwandi', 'db262090fe0628ad0c8286bdeb18160e', 'Purwandi', 'MM', NULL, NULL),
(21, 'Nino', 'cdb7c28a5c9d02ac0aa9c42f68bb06d1', 'Nino', 'MM', NULL, NULL),
(22, 'Thomas', 'fe712a1ff3e1626715a33f16a799bbe8', 'Thomas', 'MM', 'Thomas', '2018-06-02 02:44:50'),
(23, 'Zamroni', '0c03841cd1a3ffa00b31f4af9567bf1f', 'Zamroni', 'PM', NULL, NULL),
(24, 'Achmad', '489e590f395450e2b539aca47c261dd9', 'Achmad', 'PM', 'Admin', '2018-06-01 23:23:11'),
(25, 'Rita', 'd0a29d3812f01152fa82238b28eaff92', 'Rita', 'PP', NULL, NULL),
(26, 'Fitri', 'cc64d9da75a1414a49ea891f29f46e38', 'Fitri', 'PP', NULL, NULL),
(28, 'Rendra', '79e8b8bbb68ea8ac7720e107a7b92b86', 'Rendra', 'SD', NULL, NULL),
(29, 'Suyanto', '9dbc978b222972f94ab3f2c47e4b1516', 'Suyanto', 'SD', NULL, NULL),
(30, 'Alex', '6f876c56df96a8db87b81a67f38ed083', 'Alex', 'SD', NULL, NULL),
(31, 'Wasti', 'cf0935412950af3783abb44860d90bfa', 'Wasti', 'SD', NULL, NULL);
...
(19, 'Enterprise Structure', 'Define BA', 'SPRO', 'V_TGSB', 'Create', 'FICO', 'OK', 2065, 'isi', '2018-06-02', 'Andrean', 'Admin', '2018-06-02 23:12:15'),
(20, 'Enterprise Structure', 'Assign Business Area to Consolidation Business Area', 'SPRO', 'V_GSB_A', 'Check', 'FICO', 'OK', 2065, 'nomor', '2018-06-06', 'Aris', 'Aris', '2018-06-02 23:32:17'),
...
(8, 'Penjualan Botolan Reguler (MTS)', 8, 'Konversi Inquiry ke SO setelah konfirm ke relasi (Khusus MR)', 'ZSDENH043', 'Sales Counter', '1000', 'in', 'out', 'Thomas', '2018-06-02', 'Thomas', '2018-06-02 03:13:11'),
...
(22, 'Penjualan Botolan Reguler (MTS)', 1, 'Buat Sales Order', 'VA01', 'Sales Counter', '2065', 'input', 'out', 'Admin', '2018-06-02', 'Aris', '2018-06-02 23:49:39'),
(23, 'Penjualan Botolan Reguler (MTS)', 2, 'Release SO (Credit Management)', 'ZSDENH006', 'Management', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(24, 'Penjualan Botolan Reguler (MTS)', 3, 'Cetak SO', 'VA03', 'Sales Counter', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(25, 'Penjualan Botolan Reguler (MTS)', 4, 'Perintah Packing oleh Sales Counter', 'ZSDENH039', 'Sales Counter', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(26, 'Penjualan Botolan Reguler (MTS)', 5, 'Create TTBK & GR ke Sloc Empty Pack', 'ZMMENH025', 'Adm.Panggung', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(27, 'Penjualan Botolan Reguler (MTS)', 6, 'Konfirmasi SO & Buat Inquiry Jika Ada Pekerjaan Tambahan (Khusus MR)', 'ZSDENH040', 'Panggung', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(28, 'Penjualan Botolan Reguler (MTS)', 7, 'Report', 'ZSDRPT047', 'Panggung', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(29, 'Penjualan Botolan Reguler (MTS)', 8, 'Konversi Inquiry ke SO setelah konfirm ke relasi (Khusus MR)', 'ZSDENH043', 'Sales Counter', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(30, 'Penjualan Botolan Reguler (MTS)', 9, 'Report', 'ZSDRPT047', 'Sales Counter', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(31, 'Penjualan Botolan Reguler (MTS)', 10, 'Prosedur Running MRP & Create PRO MTS', 'ZSDENH043', 'PPIC', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(32, 'Penjualan Botolan Reguler (MTS)', 11, 'Input Hasil Produksi', 'ZPPENH001', 'Produksi', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(33, 'Penjualan Botolan Reguler (MTS)', 12, 'Transfer Packing dari Sloc Full Pack ke Sloc Distribusi', 'ZSDENH040', 'Adm.Panggung', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(34, 'Penjualan Botolan Reguler (MTS)', 13, 'Cetak Packing List (Dilampirkan di SO)', 'ZSDENH040', 'Adm.Panggung', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(35, 'Penjualan Botolan Reguler (MTS)', 14, 'Posting (GI) Surat Jalan', 'VL01N', 'Distribusi/Logistik', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(36, 'Penjualan Botolan Reguler (MTS)', 15, 'Posting (GI) Surat Jalan', 'VL02N', 'Distribusi/Logistik', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(37, 'Penjualan Botolan Reguler (MTS)', 16, 'Cetak Surat Jalan', 'VL03N', 'Distribusi/Logistik', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(38, 'Penjualan Botolan Reguler (MTS)', 17, 'Create Invoice', 'VF01', 'Adm.Penjualan', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(39, 'Penjualan Botolan Reguler (MTS)', 18, 'Cetak Invoice', 'VF03', 'Adm.Penjualan', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(40, 'Penjualan Botolan Reguler (MTS)', 19, 'Cetak Faktur Pajak', 'ZFIRPT038', 'Adm.Penjualan', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(41, 'Penjualan Botolan Reguler (MTS)', 20, 'Terima Plns dari Customer via Bank BCA Test Transfer', 'F-21', 'GL Bank', '2065', NULL, NULL, NULL, NULL, NULL, NULL),
(42, 'Penjualan Botolan Reguler (MTS)', 21, 'Account Clear AR', 'F-32', 'Adm.Piutang', '2065', NULL, NULL, NULL, NULL, NULL, NULL);
